...
Scenario: enter an invalid email add and enter an invalid password
	Given User is on log in page
	And User enters email address demousermicrosoft.com
	And User enters Password Pass@wor
	When click on the Log in button 
	Then Error message The Email field is not a valid e-mail address. appears
	And Another error message appears below the field Email: The Email field is not a valid e-mail address.
